...
BrownianMotion::BrownianMotion(const float q_xy, const float q_z, const float theta, const float cone_angle, const unsigned int seed) noexcept :
    F_(MatrixXf::Identity(6, 6)), q_xy_(q_xy), q_z_(q_z), theta_(theta * (M_PI/180.0)), cone_angle_(cone_angle * (M_PI/180.0)),
...
BrownianMotion::BrownianMotion(const BrownianMotion& brown) :
    F_(brown.F_), q_xy_(brown.q_xy_), q_z_(brown.q_z_), theta_(brown.theta_), cone_angle_(brown.cone_angle_),
...
BrownianMotion::BrownianMotion(BrownianMotion&& brown) noexcept :
    F_(std::move(brown.F_)), q_xy_(brown.q_xy_), theta_(brown.theta_), cone_angle_(brown.cone_angle_),
